...
//            _timeLab.text = title;
//            _tipLab.text = subTitle;
            _timeLab.attributedText = [NSString attributedStringWithString:@"交易号："  stringColor:HEXCOLOR(0x666666) stringFont:kFontSize(15) subString:[NSString stringWithFormat:@"%@",subTitle] subStringColor:HEXCOLOR(0x333333) subStringFont:kFontSize(16)];
            _tipLab.attributedText = [NSString attributedStringWithString:@"区块：" stringColor:HEXCOLOR(0x666666) stringFont:kFontSize(15) subString:[NSString stringWithFormat:@"%@",subTitle] subStringColor:HEXCOLOR(0x333333) subStringFont:kFontSize(16)];
